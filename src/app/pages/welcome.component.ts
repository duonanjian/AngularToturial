...
export class WelcomeComponent implements OnInit, OnChanges {
    ...
    userinfo: UserInfo;
    class!: true;
    constructor(private router: Router, private route: ActivatedRoute, private storeService: StoreService, private DataService: DataService) {
        ...
        this.menulist = [
            ...
            { name: '动态变更策略', path: '/basic/changedetection' }
        ];
        this.userinfo = {
            username: 'admin',
            password: 12345,
